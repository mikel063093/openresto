...
public partial class BookingMapper
{
    ...
    [MapperIgnoreSource(nameof(Booking.CustomerPhoneE164))]
    [MapperIgnoreSource(nameof(Booking.CustomerPhoneNormalized))]
    ...
    [MapperIgnoreTarget(nameof(Booking.CustomerPhoneE164))]
    [MapperIgnoreTarget(nameof(Booking.CustomerPhoneNormalized))]
